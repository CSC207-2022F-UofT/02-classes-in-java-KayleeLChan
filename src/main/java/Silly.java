...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param first_half the first part of this Silly instance's name.
     * @param second_half the second part of this Silly instance's name.
     */
    public Silly(String first_half, String second_half) {
        this.name = first_half + second_half;
    }
